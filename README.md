...
> **Fingerprint Electron fork** (forkcc): this fork adds support for building
> installers from [fingerprint-electron](https://github.com/forkcc/fingerprint-electron)
> (Chromium 153.0.8001.0, version `153.0.0-dev`). Dev-style versions are
> normalized to the numeric `x.y.z.w` form required by NSIS before
